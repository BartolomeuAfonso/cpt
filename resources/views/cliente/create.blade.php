        ...
        <section class="section dashboard">
            <div class="row">
                <div class="container-fluid">
                    ...
                    @endif
                    <form method="post" action="{{ url('salvarPessoa') }}">
                        @csrf
                        <div class="col-lg-12" style="background-color:white;">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="card-title" style="font-weight: bold">Registo de Pessoal</h2>

                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                                data-bs-target="#home" type="button" style="font-weight: bold" role="tab"
                                                aria-controls="home" aria-selected="true">1. Dados
                                                Pessoais</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                                data-bs-target="#profile" type="button" role="tab" aria-controls="profile"
                                                aria-selected="false" style="font-weight: bold">2. Dados
                                                profissionais</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                                data-bs-target="#contact" type="button" role="tab" aria-controls="contact"
                                                aria-selected="false" style="font-weight: bold">3. Dados do Proprietário da
                                                Viatura</button>
                                        </li>
                                    </ul>
                                    <!------------------------------------------- Dados Pessoais ---------------->
                                    <div class="tab-content pt-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="home" role="tabpanel"
                                            aria-labelledby="home-tab" style="height: 400px; margin-top:10px">
                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                <div class="col-8">
                                                    <label for="nome" class="label mr-1">Nome<span style="color:red">
                                                            *</span></label>
                                                    <input name="nome" style="font-weight: bold" class="form-control"
                                                        required="" id="nome">
                                                </div>
                                            ...
                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                <div class="col-6">
                                                    <label for="sector" class="label mr-1">Filiação (Pai)<span
                                                            style="color:red"> *</span> </label>
                                                    <input name="pai" style="font-weight: bold" class="form-control"
                                                        required="" id="pai">
                                                </div>
                                                <div class="col-6">
                                                    <label class="label mr-1" for="mae"> e de (Mãe)<span
                                                            style="color:red">
                                                            *</span></label>
                                                    <input name="mae" style="font-weight: bold" class="form-control"
                                                        required="" id="mae">
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                ...
                                                <div class="col-4">
                                                    <label class="label mr-1" for="dataNasc">Data de Nascimento<span
                                                            style="color:red"> *</span></label>
                                                    <input name="dataNasc" style="font-weight: bold;" type="date"
                                                        value="{{ date('Y') . '-' . date('m') . '-' . date('d') }}"
                                                        class="form-control" id="dataNasc" required="">
                                                </div>
                                            </div>

                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                <div class="col-6">
                                                    <label class="label mr-1" for="naturalidade">Naturalidade<span
                                                            style="color:red"> *</span></label>
                                                    <input name="naturalidade" style="font-weight: bold"
                                                        class="form-control" id="naturalidade" required="">
                                                </div>
                                                <div class="col-6">
                                                    <label for="nBi" class="label mr-1">Nº do
                                                        B.I./Cédula/Passaporte*</label>
                                                    <input name="nBi" style="font-weight: bold;" class="form-control"
                                                        id="nBi" required="">
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                <div class="col-4">
                                                    ...
                                                    <select style="font-weight: bold;" class="form-select"
                                                        name="biprovincia" id="biprovincia" required="">
                                                ...
                                                <div class="col-5">
                                                    <label class="label mr-1" for="municipio">Município<span
                                                            style="color:red"> *</span></label>
                                                    <select class="form-select" style="font-weight: bold;"
                                                        name="bimunicipio" id="bimunicipio" required="">

                                                    </select>
                                                </div>
                                                <div class="col-3">
                                                    <label class="label mr-1" for="municipio">Residência</label>
                                                    <input name="biendereco" style="font-weight: bold"
                                                        class="form-control" id="biendereco">
                                                </div>
                                                <br>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="profile" role="tabpanel"
                                            ...
                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                <div class="col-4">
                                                    ...
                                                    <input name="contacto" class="form-control" id="contacto" required="">
                                                </div>
                                                <div class="col-4">
                                        ...
                                        <div class="tab-pane fade" id="contact" role="tabpanel"
                                            aria-labelledby="contact-tab" style="height: 400px;  margin-top:10px">
                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                <div class="col-4">
                                                    <label for="matricula" class="label mr-1">Matricula<span
                                                            style="color:red"> *</span></label>
                                                    <input name="matricula" style="font-weight: bold" type="text"
                                                        class="form-control" id="matricula" required="">
                                                </div>
                                                <div class="col-4">
                                                    <label for="data_venc_seguro" class="label mr-1">Data de vencimento
                                                        da
                                                        seguro</label>
                                                    <input name="data_venc_seguro" type="date"
                                                        value="<?= date('Y') . '-' . date('m') . '-' . date('d') ?>"
                                                        class="form-control" id="data_venc_seguro">
                                                </div>
                                                <div class="col-4">
                                                    <label for="data_venc_licenca" class="label mr-1">Data de vencimento
                                                        do
                                                        licença</label>
                                                    <input name="data_venc_licenca" type="date"
                                                        value="<?= date('Y') . '-' . date('m') . '-' . date('d') ?>"
                                                        class="form-control" id="data_venc_licenca">
                                                </div>
                                            </div>
                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                <div class="col-8">
                                                    ...
                                                    <input name="nome_proprietario" style="font-weight: bold"
                                                        class="form-control" id="nome_proprietario" required="">
                                                </div>
                                            </div>

                                            <div class="row" style="margin-left: 5px;margin-right: 10px;">
                                                <div class="col-4">
                                                    <label for="telefone_proprietario" class="label mr-1">Telefone<span
                                                            style="color:red"> *</span></label>
                                                    <input name="telefone_proprietario" class="form-control"
                                                        id="telefone_proprietario" required="">
                                                </div>
                                                <div class="col-4">
                                                    <label for="telefone_proprietario_alt" class="label mr-1">Telefone
                                                        (Alternativo)</label>
                                                    <input name="telefone_proprietario_alt" style="font-weight: bold"
                                                        class="form-control" id="telefone_proprietario_alt">
                                                </div>

                                                <div class="col-4">
                                                    <label for="email_proprietario" class="label mr-1">Email</label>
                                                    <input name="email_proprietario" class="form-control"
                                ...
                                <div class="row mb-3" style="margin-left:  10px">
                                    <div class="col-sm-10">
                                        <p>Todos os campos com <span style="color:red"> *</span> são obrigatório, deve
                                            preencher as informação nas três ambas e no final Salvar</p>
                                    </div>
                                </div>
                                <div class="row mb-3" style="margin-left: 10px">
                                    <div class="col-sm-10">
