        ...
        <div class="row" >
            <div class="col-lg-10" >
                <div class="card">
                    ...
                    <form role="form" method="post" action="{{url('resumoMensal')}}">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="col-3">
                                       ...
                                       <input type="date"   value="<?= date('Y') . '-' . date('m') . '-' . date('d') ?>" name="dataInicio" class="form-control">
                                      </div>
                                     <div class="col-3">
                                         <label for="data2">Data Final:</label>
                                         <input type="date"   value="<?= date('Y') . '-' . date('m') . '-' . date('d') ?>"  name="dataFinal" class="form-control">
                                      </div>
                            </div>
                        </div>
